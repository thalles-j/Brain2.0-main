document.addEventListener('DOMContentLoaded', function () {
    ...
    if (nomeUsuario) {
        contentBoasVindas.innerHTML = `<p>Seja bem-vindo, <strong>${nomeUsuario}</strong>! Este é um espaço seguro onde você pode compartilhar suas emoções e experiências. Estamos aqui para ouvir você e apoiar seu bem-estar. 💙</p>`;
    } else {
